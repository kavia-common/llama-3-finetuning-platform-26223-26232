...
/**
 * Simple endpoints for health and documentation redirection.
 */
@RestController
@Tag(name = "Hello Controller", description = "Basic endpoints for finetunellama3backend")
public class HelloController {
    ...
    public String hello() {
        return "Hello, Spring Boot! Welcome to finetunellama3backend";
    }
    ...
    public String info() {
        return "Spring Boot Application: finetunellama3backend";
    }
}
